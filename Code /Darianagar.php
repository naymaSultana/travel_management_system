...
<!--header section ends-->
<div class="heading" style="background:url(images/Daria6.jpg") no-repeat> 
    <h1>Darianagar</h1>
</div>    
...
<section class="about">
    <div class="image">
        <img src="images/Daria5.jpg" alt="">
    </div>

    <div class="content">
        <h3>Darianagar, Natore</h3>
        <h1><p>About it</p></h1>
        <p>Dariyapur Zamindar Bari, a historical treasure nestled in Natore, Bangladesh, evokes the grandeur of bygone eras. This majestic mansion, with its intricate architecture and sprawling courtyards, echoes tales of the zamindars' opulent lifestyle. Preserving rich heritage, it stands as a testament to the region's cultural and architectural legacy.</p>
        <h1><p>Our Packages</p></h1>
        <p>Solo package-750/-</p>
        <p>Group package-per person 700/-</p>
        <h1><p>our ensurement</p></h1>
        <p>We ensure 1 day enjoyment of our luxury package 'Darianagar'. Here you can enjoy the site view, can enjoy local food and we will provide a set of local dresses and personal photographer.</p>
        <p>You can have Transportation, accomodation, guided tours, bird watching, historical talks held by experts, cultural experiences, adventure activities, flexible itinerary options, multilingual assistance.</p>
        ...
        <input type="hidden" name = "location" value="Darianagar" />
