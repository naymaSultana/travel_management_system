...
<!--header section ends-->
<div class="heading" style="background:url(images/temple2.jpg") no-repeat> 
    <h1>Kantajew Temple</h1>
</div>    


<section class="about">
    <div class="image">
        <img src="images/temple3.jpg" alt="">
    </div>

    <div class="content">
        <h3>Kantajew Temple, Dinajpur</h3>
        <h1><p>About it</p></h1>
        <p>Kantajew Temple, nestled in the ancient town of Dinajpur, Bangladesh, stands as a testament to divine craftsmanship. Adorned with exquisite terracotta panels and ornate sculptures, this Hindu temple mesmerizes with its architectural grandeur. Amidst serene surroundings, it serves as a sacred sanctuary, inviting devotees and visitors to marvel at its timeless beauty.</p>
        <h1><p>Our Packages</p></h1>
        <p>Solo package-750/-</p>
        <p>Group package-per person 700/-</p>
        <h1><p>our ensurement</p></h1>
        <p>We ensure 1 day enjoyment of our luxury package 'Kantajew temple'. Here you can enjoy the site view, can enjoy local food and we will provide a set of local dresses and personal photographer.</p>
        <p>You can have transportation, Accomodation, guided tours, photography workshops, night sky photograpy workshop. </p>
        ...
        <input type="hidden" name = "location" value="Kantajew Temple" />
