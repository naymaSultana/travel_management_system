...
<!--header section ends-->
<div class="heading" style="background:url(images/guava.jpg") no-repeat> 
    <h1>Guava Market</h1>
</div>    
...
<section class="about">
    <div class="image">
        <img src="images/guava2.jpg" alt="">
    </div>

    <div class="content">
        <h3>Guava Market, Barisal</h3>
        <h1><p>About it</p></h1>
        <p>The Floating Guava Market in Barisal, Bangladesh, presents a charming spectacle where local farmers peddle their freshly harvested guavas from boats. Nestled along the waterways, this unique market offers a picturesque scene, bustling with activity and vibrant colors. It's a beloved attraction, drawing visitors to experience the essence of traditional riverine commerce.</p>
        <h1><p>Our Packages</p></h1>
        <p>Solo package-1500/-</p>
        <p>Group package-per person 1400/-</p>
        <h1><p>our ensurement</p></h1>
        <p>We ensure 2 days enjoyment of our luxury package 'Guava Market'. Here you can enjoy the site view, can enjoy local food and we will provide a set of local dresses and personal photographer.</p>
        <p>You can have transportation, Accomodation, guided tours, photography workshops, night sky photograpy workshop, fresh fruit, personal boat. </p>
        ...
        <input type="hidden" name = "location" value="Guava Market" />
