...
<head>
    ...
    <title>Gangamati Reserved Forest</title>
...
<!--header section ends-->
<div class="heading" style="background:url(images/ganga2.jpg") no-repeat> 
    <h1>Gangamati Reserved Forest</h1>
</div>    


<section class="about">
    <div class="image">
        <img src="images/ganga3.jpg" alt="">
    </div>

    <div class="content">
        <h3>Gangamati Reserved Forest, Khulna</h3>
        <h1><p>About it</p></h1>
        <p>Gangamati Reserved Forest, cradled in the heart of Khulna, Bangladesh, is a sanctuary of biodiversity. Its dense foliage and winding trails provide refuge to diverse flora and fauna. From towering trees to elusive wildlife, the forest offers a serene escape into the wilderness, inviting adventurers to explore its hidden treasures.</p>
        <h1><p>Our Packages</p></h1>
        <p>Solo package-2500/-</p>
        <p>Group package-per person 2300/-</p>
        <h1><p>our ensurement</p></h1>
        <p>We ensure 3 days enjoyment of our luxury package 'Gangamati forest'. Here you can enjoy the site view, can enjoy local food and we will provide a set of local dresses and personal photographer.</p>
        <p>You can have transportation, Accomodation, cultural excursion, photography tour, forest exploration, animal watching.</p>

        <form action="book_location.php" method="post">
        <input type="hidden" name = "location" value="Gangamati" />
