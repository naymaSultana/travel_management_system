...
<!--header section ends-->
<div class="heading" style="background:url(images/teota2.jpg") no-repeat> 
    <h1>Teota Palace</h1>
</div>    
...
<section class="about">
    <div class="image">
        <img src="images/teota3.jpg" alt="">
    </div>

    <div class="content">
        <h3>Teota Palace, Manikganj</h3>
        <h1><p>About it</p></h1>
        <p>Teota Zamindar Bari, nestled in Bangladesh's Manikganj district, echoes the grandeur of Bengal's architectural heritage. Constructed during the colonial era, it served as the opulent residence of influential landlords. With its sprawling mansion, verdant gardens, and serene ponds, the estate remains a captivating testament to the region's rich history and cultural legacy.</p>
        <h1><p>Our Packages</p></h1>
        <p>Solo package-750/-</p>
        <p>Group package-per person 700/-</p>
        <h1><p>our ensurement</p></h1>
        <p>We ensure 1 day enjoyment of our luxury package 'Teota Palace'. Here you can enjoy the site view, can enjoy local food and we will provide a set of local dresses and personal photographer.</p>
        <p>You can have transportation, Accomodation, guided tours, photography workshops, night sky photograpy workshop, historical information, personal guide. </p>
        ...
        <input type="hidden" name = "location" value="Teota Palace" />
