...
<!--header section ends-->
<div class="heading" style="background:url(images/ratno2.jpg") no-repeat> 
    <h1>Ratnodweep</h1>
</div>    
...
<section class="about">
    <div class="image">
        <img src="images/ratno3.jpg" alt="">
    </div>

    <div class="content">
        <h3>Ratnodweep, Barishal</h3>
        <h1><p>About it</p></h1>
        <p>Ratnodweep, nestled in the picturesque landscapes of Barishal, Bangladesh, is an island of serenity. Surrounded by tranquil waters and swaying palms, it offers a tranquil retreat from the hustle and bustle of city life. With its traditional boat races and vibrant Rash Mela festival, Ratnodweep captivates visitors with its cultural charm.</p>
        <h1><p>Our Packages</p></h1>
        <p>Solo package-2500/-</p>
        <p>Group package-per person 2300/-</p>
        <h1><p>our ensurement</p></h1>
        <p>We ensure 3 days enjoyment of our luxury package 'Ratnodweep'. Here you can enjoy the site view, can enjoy local food and we will provide a set of local dresses and personal photographer.</p>
        <p>You can have transportation, Accomodation, guided tours, stargazing programs, photography tours, family-friendly packages.</p>
        
        
        <div class="icons-container">
            <div class="icons">
                <span>boat night stay</span>
            </div>
        ...
        <input type="hidden" name = "location" value="Ratnodweep" />
