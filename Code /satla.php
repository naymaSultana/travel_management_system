...
<!--header section ends-->
<div class="heading" style="background:url(images/satla2.jpg") no-repeat> 
    <h1>Satla Beel</h1>
</div>    
...
<section class="about">
    ...
    <div class="content">
        <h3>Satla Beel, Gopalganj</h3>
        <h1><p>About it</p></h1>
        <p>Satla Beel, nestled in Gopalganj district of Bangladesh, is a revered wetland sanctuary. It harbors diverse ecosystems, nurturing rich flora and fauna, including migratory birds. Its tranquil waters and surrounding verdant landscapes make it a haven for nature enthusiasts, offering serene vistas and opportunities for birdwatching and eco-tourism adventures.</p>
        <h1><p>Our Packages</p></h1>
        <p>Solo package-750/-</p>
        <p>Group package-per person 700/-</p>
        <h1><p>our ensurement</p></h1>
        <p>We ensure 1 day enjoyment of our luxury package 'Satla Beel'. Here you can enjoy the site view, can enjoy local food and we will provide a set of local dresses and personal photographer.</p>
        ...
        <input type="hidden" name = "location" value="Satla" />
