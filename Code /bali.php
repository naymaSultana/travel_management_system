...
<!--header section ends-->
<div class="heading" style="background:url(images/bali2.jpg") no-repeat> 
    <h1>baliati palace</h1>
</div>    


<section class="about">
    <div class="image">
        <img src="images/bali3.jpg" alt="">
    </div>

    <div class="content">
        <h3>Baliati Palace, Manikganj</h3>
        <h1><p>About it</p></h1>
        <p>The Baliati Palace, nestled in Manikganj, Bangladesh, epitomizes architectural elegance with its fusion of European and Mughal styles. Built in the early 19th century by the Roy Chowdhury family, it served as both residence and administrative hub. Today, this historic gem stands as a testament to Bengal's rich cultural heritage.</p>
        <h1><p>Our Packages</p></h1>
        <p>Solo package-750/-</p>
        <p>Group package-per person 700/-</p>
        <h1><p>our ensurement</p></h1>
        <p>We ensure 1 day enjoyment of our luxury package 'Baliati Palace'. Here you can enjoy the site view, can enjoy local food and we will provide a set of local dresses and personal photographer.</p>
        ...
        <input type="hidden" name = "location" value="Baliati Palace" />
