...
<!--header section ends-->
<div class="heading" style="background:url(images/lal.jpg") no-repeat> 
    <h1>Lal Pahar</h1>
</div>    
...
<section class="about">
    <div class="image">
        <img src="images/lal3.jpg" alt="">
    </div>

    <div class="content">
        <h3>Lal Pahar, Sylhet</h3>
        <h1><p>About it</p></h1>
        <p>Lal Pahar, or Red Hill, graces Sreemongol with its striking crimson soil, a mesmerizing spectacle especially at sunset. Nestled amidst lush tea gardens, it offers panoramic vistas of verdant landscapes. Renowned for its unique hue caused by iron-rich soil, Lal Pahar is a must-visit attraction for nature enthusiasts and photographers alike.</p>
        <h1><p>Our Packages</p></h1>
        <p>Solo package-1500/-</p>
        <p>Group package-per person 1400/-</p>
        <h1><p>our ensurement</p></h1>
        <p>We ensure 2 days enjoyment of our luxury package 'Lal Pahar'. Here you can enjoy the view of the velvety tea gardens, can enjoy local food and we will provide a set of local dresses and personal photographer.</p>
        ...
        <input type="hidden" name = "location" value="Lal Pahar" />
