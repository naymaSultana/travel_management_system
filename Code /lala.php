...
<!--header section ends-->
<div class="heading" style="background:url(images/lala1.jpg") no-repeat> 
    <h1>Lalakhal</h1>
</div>    
...
<section class="about">
    <div class="image">
        <img src="images/lala3.jpg" alt="">
    </div>

    <div class="content">
        <h3>Lalakhal, Sylhet</h3>
        <h1><p>About it</p></h1>
        <p>Lalakhal, nestled in Sylhet, Bangladesh, captivates with its enchanting beauty. This pristine river, adorned with emerald-green waters, offers a serene escape amid lush landscapes. Renowned for its tranquility and scenic boat rides, Lalakhal remains an untouched gem, inviting travelers to immerse themselves in nature's tranquil embrace.</p>
        <h1><p>Our Packages</p></h1>
        <p>Solo package-1500/-</p>
        <p>Group package-per person 1400/-</p>
        <h1><p>our ensurement</p></h1>
        <p>We ensure 2 days enjoyment of our luxury package 'Lalakhal'. Here you can enjoy the site view, can enjoy local food and we will provide a set of local dresses and personal photographer.</p>
        <p>You can have Transportation, accomodation, guided tours, boat tours, hiking trails, bird watching, cultural experiences, adventure activities, flexible itinerary options, multilingual assistance.</p>

        <div class="icons-container">
            <div class="icons">
                <span>hiking options</span>
            </div>
        ...
        <input type="hidden" name = "location" value="Lalakhal" />
