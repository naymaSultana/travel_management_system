...
<!--header section ends-->
<div class="heading" style="background:url(images/bhawal2.jpg") no-repeat> 
...
<section class="about">
    <div class="image">
        <img src="images/bhawal3.jpg" alt="">
    </div>

    <div class="content">
        <h3>Bhawal National Park, Gazipur</h3>
        <h1><p>About it</p></h1>
        <p>Bhawal National Park, cradled in the tranquility of Gazipur, Bangladesh, unfolds a sanctuary of biodiversity. Its verdant expanse shelters diverse flora and fauna, offering a haven for nature enthusiasts. With lush forests, meandering trails, and serene lakes, the park beckons visitors to immerse themselves in the splendor of untouched wilderness.</p>
        <h1><p>Our Packages</p></h1>
        <p>Solo package-750/-</p>
        <p>Group package-per person 700/-</p>
        <h1><p>our ensurement</p></h1>
        <p>We ensure 1 day enjoyment of our luxury package 'Bhawal National Park'. Here you can enjoy the site view, can enjoy local food and we will provide a set of local dresses and personal photographer.</p>
        <p>You can have transportation, accomodation, guided tour, wildlife excursion, cultural experiences, adventure activities, photography opportunities, educational programs, flexible itineraries, environmental conservation initiatives.</p>
        ...
        <input type="hidden" name = "location" value="Bhawal" />
