...
<!--header section ends-->
<div class="heading" style="background:url(images/baikka2.jpg") no-repeat> 
    <h1>Baikka Beel</h1>
</div>    
...
<section class="about">
    <div class="image">
        <img src="images/baikka3.jpg" alt="">
    </div>

    <div class="content">
        <h3>Baikka Beel, Sylhet</h3>
        <h1><p>About it</p></h1>
        <p>Baikka Beel is a picturesque wetland sanctuary nestled in Sylhet, Bangladesh. Spanning lush greenery and serene water bodies, it hosts diverse flora and fauna, including migratory birds. The tranquil ambiance and vibrant biodiversity make it a haven for nature lovers and photographers seeking solace and captivating landscapes.</p>
        <h1><p>Our Packages</p></h1>
        <p>Solo package-750/-</p>
        <p>Group package-per person 700/-</p>
        <h1><p>our ensurement</p></h1>
        <p>We ensure 1 day enjoyment of our luxury package 'Baikka Beel'. Here you can enjoy the site view, can enjoy local food and we will provide a set of local dresses and personal photographer.</p>
        <p>You can have transportation, Accomodation, guided tours, local culinary experiences, boat tours, photography workshops. </p>
        ...
        <input type="hidden" name = "location" value="Baikka" />
