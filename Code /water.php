...
<!--header section ends-->
<div class="heading" style="background:url(images/water2.jpg") no-repeat> 
    <h1>Jadipai Waterfall</h1>
</div>    
...
<section class="about">
    ...
    <div class="content">
        <h3>Jadipai Waterfall, Bandarban</h3>
        <h1><p>About it</p></h1>
        <p>Jadipai Waterfall, nestled amidst the verdant hills of Bandarban, Bangladesh, cascades with ethereal beauty. Its crystalline waters tumble down rugged cliffs, creating a mesmerizing spectacle. Surrounded by lush greenery and serenity, Jadipai offers a tranquil haven for nature enthusiasts seeking solace in the embrace of untouched wilderness.</p>
        <h1><p>Our Packages</p></h1>
        <p>Solo package-1500/-</p>
        <p>Group package-per person 1400/-</p>
        <h1><p>our ensurement</p></h1>
        <p>We ensure 2 days enjoyment of our luxury package 'Jadipai Waterfall'. Here you can enjoy the site view, can enjoy local food and we will provide a set of local dresses and personal photographer.</p>
        <p>You can have transportation, Accomodation, guided tours, local culinary experiences, wildlife photography, underwater photography.</p>
        ...
        <input type="hidden" name = "location" value="Jadipai Waterfall" />
