...
<head>
    ...
    <title>Puthia Rajbari Complex</title>
...
<!--header section ends-->
<div class="heading" style="background:url(images/rajbari2.jpg") no-repeat> 
    <h1>Puthia Rajbari Complex</h1>
</div>    


<section class="about">
    <div class="image">
        <img src="images/rajbari3.jpg" alt="">
    </div>

    <div class="content">
        <h3>Puthia Rajbari Complex, Rajshahi</h3>
        <h1><p>About it</p></h1>
        <p>Puthia Rajbari, nestled in the historical tapestry of Rajshahi, Bangladesh, exudes regal splendor. This architectural marvel boasts ornate Hindu temples and palatial structures adorned with intricate terracotta designs. Amidst sprawling courtyards and serene gardens, it echoes tales of a bygone era, preserving the rich heritage of the region.</p>
        <h1><p>Our Packages</p></h1>
        <p>Solo package-750/-</p>
        <p>Group package-per person 700/-$</p>
        <h1><p>our ensurement</p></h1>
        <p>We ensure 1 day enjoyment of our luxury package 'Puthia Rajbari'. Here you can enjoy the site view, can enjoy local food and we will provide a set of local dresses and personal photographer.</p>
        <p>You can have transportation, Accomodation, guided tours, historical sightseeing, stargazing programs.</p>
        ...
        <div class="icons-container">
            ...
            <div class="icons">
                <span>nightstay at rajbari</span>
            </div>
            <div class="icons">
        ...
        <input type="hidden" name = "location" value="Puthia" />
